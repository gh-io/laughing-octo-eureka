---
title: program:`lit` [*options*] [*tests*]
Descrition: lit LLVM Integrated Tester
puts: hello_world
puts: program_lit
Puts: SYNOPSIS
env: clang ruby_
